  ...
  return (
    <section className="bg-[#0c0c0c] py-16">
      ...
      <div className="text-center mb-10 px-6">
        <p
          className="text-[11px] tracking-[0.2em] text-white/25 uppercase mb-3"
          style={{ fontFamily: 'DM Sans, sans-serif' }}
        >
          From the journal
        </p>
